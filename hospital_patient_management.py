    ...
    try:
        ...
        for record in original_records:
            ...
            if not validate_age(age):
                print("Invalid age record removed:", name, "| Age:", age)
                continue

            if not validate_phone(phone):
                print("Invalid or missing phone:", name)
                phone = "Not Available"

            if not validate_email(email):
                print("Invalid or missing email:", name)
                email = "Not Available"
            ...
            if duplicate_key in seen_records:
                print("Exact duplicate removed:", name)
                continue
        ...
        test_patients = [
            (101, "rajesh KUMAR", 32, "male",
             "9876543299", "rajesh@gmail.com", "Fever"),

            (102, "RAJESH kumar", 32, "M",
             "9876543299", "rajesh@gmail.com", "Fever"),

            (103, "Divya", -10, "Female",
             "9876543201", "divya@gmail.com", "Cold"),
        ...
        for record in test_patients:
            ...
            if not validate_age(age):
                print("Invalid age removed:", name)
                continue

            if not validate_phone(phone):
                print("Invalid phone detected:", name)
                phone = "Not Available"

            if not validate_email(email):
                print("Missing or invalid email detected:", name)
                email = "Not Available"
            ...
            if duplicate_key in test_seen:
                print("Duplicate test record removed:", name)
                continue
